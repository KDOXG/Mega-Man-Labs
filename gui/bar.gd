...
func update_instant(hit_points: int):
    _set_current_hp_bar(hit_points)

func update_gradual(hit_points):
...
func set_bar_orientation(is_horizontal: bool):
...
func _set_current_hp_bar(hit_points: int):
